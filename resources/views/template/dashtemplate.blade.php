...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Admin Marga Lie</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/listanggota"><i class="fa-sharp fa-solid fa-user mr-05"></i> List Anggota</a>
                                    <a class="nav-link" href="/addanggota"><i class="fa-solid fa-plus mr-05"></i>Tambah Anggota</a>
                                    <a class="nav-link" href="/deletedlist"><i class="fa-solid fa-trash mr-05"></i>Anggota Terhapus</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="/listuser"><i class="fa-sharp fa-solid fa-user mr-05"></i> List User</a>
                                        <a class="nav-link" href="/adduser"><i class="fa-solid fa-plus mr-05"></i>Tambah User</a>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Marga Lie 2022</div>
                        </div>
                    </div>
                </footer>
            </div>
